...
{"HWVE",	PIXPACK(0x000000),	0.5f,	0.00f * CFDS,	1.00f,	1.00f,	0.0f,	0.0f,	0.5f,	0.000f  * CFDS,	0,	0,		0,	0,	0,	1,	-1,		SC_ADD,		R_TEMP+0.0f +273.15f,	60,		"Heat Waves. Heats surrounding particles."                  				, TYPE_ENERGY},
