...
{"REMT",	PIXPACK(0x808080),	0.0f,	0.00f * CFDS,	0.90f,	0.00f,	0.0f,	0.0f,	0.00f,	0.000f	* CFDS,	0,	0,		0,	1,	1,	1,	100,	SC_ADD,		R_TEMP+0.0f	+273.15f,	251,	"Radio Wave Emitter. Transfers signals to any Radio Wave Receiver."			, TYPE_SOLID | PROP_CONDUCTS},
{"RREC",	PIXPACK(0xA0A0A0),	0.0f,	0.00f * CFDS,	0.90f,	0.00f,	0.0f,	0.0f,	0.00f,	0.000f	* CFDS,	0,	0,		0,	1,	1,	1,	100,	SC_ADD,		R_TEMP+0.0f	+273.15f,	251,	"Radio Wave Receiver. Gets signals from any Radio Wave Emitter."			, TYPE_SOLID | PROP_CONDUCTS},
...
{"IWVE",	PIXPACK(0x000000),	0.2f,	0.00f * CFDS,	1.00f,	1.00f,	1.0f,	0.0f,	0.2f,	0.000f  * CFDS,	0,	0,		0,	0,	0,	0,	-1,		SC_RWAV,	R_TEMP+0.0f +273.15f,	60,		"Radio Waves from Emitters. Signals that are floating freely and happily."	, TYPE_ENERGY},
