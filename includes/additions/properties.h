...
{"RTNN",	PIXPACK(0x909090),	0.0f,	0.00f * CFDS,	1.00f,	1.00f,	-0.99f,	0.0f,	0.00f,	0.002f	* CFDS,	0,	0,		0,	0,	0,	1,	100,	SC_NONWAV,	R_TEMP+0.0f	+273.15f,	60,		"Tunneler. Creates tunnels horizontally to the right."                      , ST_SOLID,     TYPE_PART,                      &update_RTNN},
{"VTNN",	PIXPACK(0x909090),	0.0f,	0.00f * CFDS,	1.00f,	1.00f,	-0.99f,	0.0f,	0.00f,	0.002f	* CFDS,	0,	0,		0,	0,	0,	1,	100,	SC_NONWAV,	R_TEMP+0.0f	+273.15f,	60,		"Vertical Tunneler. Creates tunnels vertically downward."                   , ST_SOLID,     TYPE_PART,                      &update_VTNN},
