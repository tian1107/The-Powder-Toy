...
{"WEMT",	PIXPACK(0xA0A0A0),	0.0f,	0.00f * CFDS,	0.90f,	0.00f,	0.0f,	0.0f,	0.00f,	0.000f	* CFDS,	0,	0,		0,	1,	1,	1,	100,	SC_ADD,		R_TEMP+0.0f	+273.15f,	251,	"Wired Emitter. Transfers signals to any Wired Receiver."					, TYPE_SOLID | PROP_CONDUCTS,   NULL},
{"WREC",	PIXPACK(0xD0D0D0),	0.0f,	0.00f * CFDS,	0.90f,	0.00f,	0.0f,	0.0f,	0.00f,	0.000f	* CFDS,	0,	0,		0,	1,	1,	1,	100,	SC_ADD,		R_TEMP+0.0f	+273.15f,	251,	"Wired Receiver. Gets signals from any Wired Emitter."						, TYPE_SOLID | PROP_CONDUCTS,   NULL},
{"PGLW",	PIXPACK(0x63AD5F),	0.7f,	0.02f * CFDS,	0.96f,	0.80f,	0.0f,	0.1f,	0.00f,	0.000f	* CFDS,	1,	0,		0,	0,	30,	1,	70,		SC_ADD,		R_TEMP+0.0f	+273.15f,	70,		"Glow Powder. Mix to water to become GLOW."									, TYPE_PART,                    NULL},
{"IEMT",	PIXPACK(0x808080),	0.0f,	0.00f * CFDS,	0.90f,	0.00f,	0.0f,	0.0f,	0.00f,	0.000f	* CFDS,	0,	0,		0,	1,	1,	1,	100,	SC_ADD,		R_TEMP+0.0f	+273.15f,	251,	"Infrared Emitter. Transfers signals to any Infrared Receiver."			    , TYPE_SOLID | PROP_CONDUCTS,   NULL},
{"IREC",	PIXPACK(0xA0A0A0),	0.0f,	0.00f * CFDS,	0.90f,	0.00f,	0.0f,	0.0f,	0.00f,	0.000f	* CFDS,	0,	0,		0,	1,	1,	1,	100,	SC_ADD,		R_TEMP+0.0f	+273.15f,	251,	"Infrared Receiver. Gets signals from any Infrared Emitter."			    , TYPE_SOLID | PROP_CONDUCTS,   NULL},
{"IWVE",	PIXPACK(0x000000),	0.2f,	0.00f * CFDS,	1.00f,	1.00f,	1.0f,	0.0f,	0.2f,	0.000f  * CFDS,	0,	0,		0,	0,	0,	0,	-1,		SC_ADD,	    R_TEMP+0.0f +273.15f,	60,		"Infrared. Signals that are lining up in a strict manner."	                , TYPE_ENERGY,                  NULL},
{"HGEN",	PIXPACK(0x808080),	0.0f,	0.00f * CFDS,	0.90f,	0.00f,	0.0f,	0.0f,	0.00f,	0.000f	* CFDS,	0,	0,		0,	1,	1,	1,	100,	SC_ADD,		R_TEMP+0.0f	+273.15f,	251,	"Heat Generator. Generates circular heat waves."            			    , TYPE_SOLID,                   NULL},
{"HWVE",	PIXPACK(0x000000),	0.3f,	0.00f * CFDS,	1.00f,	1.00f,	0.0f,	0.0f,	0.3f,	0.000f  * CFDS,	0,	0,		0,	0,	0,	1,	-1,		SC_ADD,		    1000.0f +273.15f,	60,		"Heat Waves. Heats surrounding particles."                  				, TYPE_ENERGY,                  NULL},
{"CHLN",	PIXPACK(0x22FF00),	1.0f,	0.01f * CFDS,	0.99f,	0.330f,	-0.1f,	0.0f,	0.75f,	0.001f	* CFDS,	0,	0,	    0,	0,	0,	1,	1,		SC_ADD,		R_TEMP+2.0f	+273.15f,	42,		"Chlorine gas. Does many reactions."                                        , TYPE_GAS,                     NULL},
{"TUNN",	PIXPACK(0x909090),	0.0f,	0.00f * CFDS,	1.00f,	1.00f,	-0.99f,	0.0f,	0.00f,	0.002f	* CFDS,	0,	0,		0,	0,	0,	1,	100,	SC_ADD,	    R_TEMP+0.0f	+273.15f,	60,		"Tunneler. Creates tunnels horizontally."                                   , TYPE_PART,                    NULL},
{"VTNN",	PIXPACK(0x909090),	0.0f,	0.00f * CFDS,	1.00f,	1.00f,	-0.99f,	0.0f,	0.00f,	0.002f	* CFDS,	0,	0,		0,	0,	0,	1,	100,	SC_ADD,	    R_TEMP+0.0f	+273.15f,	60,		"Vertical Tunneler. Creates tunnels vertically."                            , TYPE_PART,                    NULL},
