...
{"PRSN",	PIXPACK(0x000000),	0.0f,	0.00f * CFDS,	0.0f,	1.0f,	0.0f,	0.1f,	0.0f,	0.00f	* CFDS,	1,	0,	    0,	0,	0,	1,	50,		SC_NONWAV,	R_TEMP+14.6f+273.15f,	0,	    "Person. Unmovable version of stickman."                                    , ST_NONE,      TYPE_PART,                      &update_PRSN},
