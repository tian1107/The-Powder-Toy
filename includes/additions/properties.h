...
{"MERC",    PIXPACK(0x787878),  0.2f,   0.01f * CFDS,   0.00f,  0.00f,  0.0f,   0.5f,   0.00f,  0.000f  * CFDS, 2,  0,      0,  0,  1,  1,  40,     SC_NONWAV,  R_TEMP+0.0f +273.15f,   251,    "Mercury. Expands and conductive, Deadly to stickmen."                      , ST_LIQUID,    TYPE_LIQUID | PROP_CONDUCTS,    &update_MERC},
{"FLCT",    PIXPACK(0xEEEEEE),  0.0f,	0.00f * CFDS,	0.97f,	0.50f,	0.0f,	0.0f,	0.00f,	0.000f	* CFDS,	0,	0,		0,	0,	12,	1,	100,	SC_NONWAV,                  0.0f,   75,     "Flourescent. Noble gas mercurified."                                       , ST_SOLID,     TYPE_SOLID                 ,    &update_FLCT},
