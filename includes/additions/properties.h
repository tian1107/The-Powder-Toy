...
{"SOAP",	PIXPACK(0xFFFFFF),	0.6f,	0.01f * CFDS,	0.98f,	0.95f,	0.0f,	0.1f,	0.00f,	0.000f	* CFDS,	2,	0,		0,	0,	20,	1,	40,		SC_NONWAV,	R_TEMP-2.0f	+273.15f,	29,		"Soap, Basic. Removes Powders, Liquids, and Gases. Neutralizes Acid."		, ST_LIQUID,    TYPE_LIQUID},
...
{"RREC",	PIXPACK(0xA0A0A0),	0.0f,	0.00f * CFDS,	0.90f,	0.00f,	0.0f,	0.0f,	0.00f,	0.000f	* CFDS,	0,	0,		0,	1,	1,	1,	100,	SC_WAV,		R_TEMP+0.0f	+273.15f,	251,	"Radio Wave Receiver. Gets signals from Radio Wave Emitters."			    , ST_SOLID,     TYPE_SOLID | PROP_CONDUCTS},
...
{"PROT",	PIXPACK(0xDDDD00),	0.2f,	0.00f * CFDS,	1.00f,	1.00f,	-0.99f,	0.0f,	0.20f,	0.002f	* CFDS,	0,	0,		0,	0,	0,	1,	-1,		SC_NONWAV,	R_TEMP+4.0f	+273.15f,	60,		"Protons. Changes elements to the next one in the element table."			, ST_NONE,      TYPE_ENERGY},
...
{"WAVE",	PIXPACK(0x000000),	0.2f,	0.00f * CFDS,	1.00f,	1.00f,	0.0f,	0.0f,	0.1f,	0.000f  * CFDS,	0,	0,		0,	0,	0,	0,	-1,		SC_WAV,	    R_TEMP+0.0f +273.15f,	60,		"Radio Waves from Emitters. Signals that are floating freely and happily."	, ST_NONE,      TYPE_ENERGY},
...
{"PGLW",	PIXPACK(0x63AD5F),	0.7f,	0.02f * CFDS,	0.96f,	0.80f,	0.0f,	0.1f,	0.00f,	0.000f	* CFDS,	1,	0,		0,	0,	30,	1,	70,		SC_NONWAV,	R_TEMP+0.0f	+273.15f,	70,		"Glow Powder. Mix to water to become GLOW."									, ST_SOLID,      TYPE_PART},
...
{"IREC",	PIXPACK(0xA0A0A0),	0.0f,	0.00f * CFDS,	0.90f,	0.00f,	0.0f,	0.0f,	0.00f,	0.000f	* CFDS,	0,	0,		0,	1,	1,	1,	100,	SC_WAV,		R_TEMP+0.0f	+273.15f,	251,	"Infrared Receiver. Gets signals from any Infrared Emitter."			    , ST_SOLID,     TYPE_SOLID | PROP_CONDUCTS},
...
{"HGEN",	PIXPACK(0x808080),	0.0f,	0.00f * CFDS,	0.90f,	0.00f,	0.0f,	0.0f,	0.00f,	0.000f	* CFDS,	0,	0,		0,	1,	1,	1,	100,	SC_WAV,		R_TEMP+0.0f	+273.15f,	251,	"Heat Generator. Generates circular heat waves."            			    , ST_SOLID,     TYPE_SOLID},
{"HWVE",	PIXPACK(0x000000),	0.3f,	0.00f * CFDS,	1.00f,	1.00f,	0.0f,	0.0f,	0.3f,	0.000f  * CFDS,	0,	0,		0,	0,	0,	1,	-1,		SC_WAV,		    1000.0f +273.15f,	60,		"Heat Waves. Heats surrounding particles."                  				, ST_NONE,      TYPE_ENERGY},
{"CHLN",	PIXPACK(0x22FF00),	1.0f,	0.01f * CFDS,	0.99f,	0.330f,	-0.1f,	0.0f,	0.75f,	0.001f	* CFDS,	0,	0,	    0,	0,	0,	1,	1,		SC_NONWAV,	R_TEMP+2.0f	+273.15f,	42,		"Chlorine gas. Does many reactions."                                        , ST_GAS,       TYPE_GAS},
{"TUNN",	PIXPACK(0x909090),	0.0f,	0.00f * CFDS,	1.00f,	1.00f,	-0.99f,	0.0f,	0.00f,	0.002f	* CFDS,	0,	0,		0,	0,	0,	1,	100,	SC_NONWAV,	R_TEMP+0.0f	+273.15f,	60,		"Tunneler. Creates tunnels horizontally."                                   , ST_SOLID,     TYPE_PART},
{"VTNN",	PIXPACK(0x909090),	0.0f,	0.00f * CFDS,	1.00f,	1.00f,	-0.99f,	0.0f,	0.00f,	0.002f	* CFDS,	0,	0,		0,	0,	0,	1,	100,	SC_NONWAV,	R_TEMP+0.0f	+273.15f,	60,		"Vertical Tunneler. Creates tunnels vertically."                            , ST_SOLID,     TYPE_PART},
{"EXPL",	PIXPACK(0xAABBCC),	0.6f,	0.01f * CFDS,	0.98f,	0.95f,	0.0f,	0.1f,	0.00f,	0.000f	* CFDS,	2,	10000,  20,  0,	50,	1,	40,		SC_NONWAV,	R_TEMP+0.0f	+273.15f,	29,		"Sensitive explosive. Keep at room temeperature and minimal pressure."      , ST_LIQUID,    TYPE_LIQUID},
{"PRSN",	PIXPACK(0x000000),	0.0f,	0.00f * CFDS,	0.0f,	1.0f,	0.0f,	0.1f,	0.0f,	0.00f	* CFDS,	1,	0,	    0,	0,	0,	1,	50,		SC_NONWAV,	R_TEMP+14.6f+273.15f,	0,	    "Person. Unmovable version of stickman."                                    , ST_NONE,      0},
{"CSTR",	PIXPACK(0xFFFF88),	0.6f,	0.01f * CFDS,	0.98f,	0.95f,	0.0f,	0.1f,	0.00f,	0.000f	* CFDS,	2,	0,		0,	0,	1,	1,	10,		SC_NONWAV,	R_TEMP+0.0f	+273.15f,	34,		"C string! stores charge from PSCN. Discharges when sufficiently charged."  , ST_LIQUID,    TYPE_LIQUID},
