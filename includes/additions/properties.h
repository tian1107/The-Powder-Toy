...
{"PROT",	PIXPACK(0xDDDD00),	0.2f,	0.00f * CFDS,	1.00f,	1.00f,	0.0f,	0.0f,	0.20f,	0.002f	* CFDS,	0,	0,		0,	0,	0,	1,	-1,		SC_NONWAV,	R_TEMP+4.0f	+273.15f,	60,		"Protons. Changes elements to the next one in the element table."			, ST_NONE,      TYPE_ENERGY,                    &update_PROT},
